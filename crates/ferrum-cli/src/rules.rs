...
use ferrum_model::{ClassReport, JarReport, MemberReport};
use serde::Serialize;
...
mod tests {
    ...
    fn recognizes_minecraft_pilot_mapping_status() {
        let mut report = JarReport {
            schema_version: 1,
            source: ferrum_model::SourceInfo {
                path: "fixture.jar".to_owned(),
                size_bytes: 0,
            },
            manifest: None,
            summary: ferrum_model::JarSummary::default(),
            classes: Vec::new(),
            errors: Vec::new(),
        };
        report.classes.push(ClassReport {
            ...
            interfaces: Vec::new(),
            version: ferrum_model::ClassVersion {
                java: 21,
                major: 65,
                minor: 0,
                preview: false,
            ...
            access: ferrum_model::AccessInfo {
                bits: 0,
                debug: String::new(),
            },
        ...
        rewrites.java_types.insert(
            ...
            "ferrum_types::Identifier".to_owned(),
        );
