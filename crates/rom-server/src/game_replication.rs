                            ...
                            .and_then(|slots| {
                                ...
                                if !connection.queue(
                                    PlayOutput::SetContainerContent {
                                        container_id: rom_game::PLAYER_CONTAINER_ID,
                                        state_id: 0,
                                        slots,
                                        carried: None,
                                    },
...
mod tests {
    ...
    use rom_game::{CommandSource, HOTBAR_START, ItemStack, Transform};
    use rom_runtime::{BoundedInputQueue, ConnectionId, worker_channel};
    ...
    fn entity_config() -> GameReplicationConfig {
        GameReplicationConfig {
            ...
            world: Some(RomPackWorld {
                data_version: rom_version_26_1_2::WORLD_VERSION,
                overworld_min_section_y: rom_version_26_1_2::OVERWORLD_MIN_SECTION_Y,
                overworld_section_count: rom_version_26_1_2::OVERWORLD_SECTION_COUNT,
                dimension: rom_version_26_1_2::OVERWORLD_DIMENSION.to_owned(),
                dimension_type_id: rom_version_26_1_2::OVERWORLD_DIMENSION_TYPE_ID,
                sea_level: rom_version_26_1_2::OVERWORLD_SEA_LEVEL,
                floor_y: rom_version_26_1_2::FLAT_WORLD_FLOOR_Y,
                spawn_x: rom_version_26_1_2::FLAT_WORLD_SPAWN_X,
                spawn_z: rom_version_26_1_2::FLAT_WORLD_SPAWN_Z,
                block_states: rom_pack::RomPackBlockStates {
                    air: rom_version_26_1_2::AIR_BLOCK_STATE_ID,
                    stone: rom_version_26_1_2::STONE_BLOCK_STATE_ID,
                    grass: rom_version_26_1_2::GRASS_BLOCK_STATE_ID,
                    dirt: rom_version_26_1_2::DIRT_BLOCK_STATE_ID,
                    bedrock: rom_version_26_1_2::BEDROCK_BLOCK_STATE_ID,
                },
                biomes: rom_pack::RomPackBiomes {
                    plains: rom_version_26_1_2::PLAINS_BIOME_ID,
                },
            }),
    ...
    fn ingest(
        workers: &mut rom_runtime::WorkerRuntime<
    ...
    fn recv_raw_output(
        ...
        loop {
            ...
            match writer.try_recv_output() {
                ...
                Err(rom_runtime::WorkerReceiveError::Empty) => {
                    assert!(
                ...
                Err(rom_runtime::WorkerReceiveError::RuntimeDisconnected) => {
